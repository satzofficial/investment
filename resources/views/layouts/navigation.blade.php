<!-- Header -->
{{-- https://img001.prntscr.com/file/img001/yg1lZ-NfTMygrKvhD-5nsA.png --}}
{{-- https://img001.prntscr.com/file/img001/UXLwaRIjRHeBURIe31kv9Q.png --}}
<div class="header header-one">
    <a href="index-2.html"
        class="d-inline-flex d-sm-inline-flex align-items-center d-md-inline-flex d-lg-none align-items-center device-logo">
        <img src="{{ asset('assets/img/logo/logo.png') }}" class="img-fluid logo2" alt="Logo">
    </a>
    <div class="main-logo d-inline float-start d-lg-flex align-items-center d-none d-sm-none d-md-none">
        <div class="logo-white">
            <a href="index-2.html">
                <img src="{{ asset('assets/img/logo/logo.png') }}" class="img-fluid logo-blue 1" alt="Logo">
            </a>
            <a href="index-2.html">
                <img src="{{ asset('assets/img/logo/icon.png') }}" class="img-fluid logo-small 2" alt="Logo">
            </a>
        </div>
        <div class="logo-color">
            <a href="index-2.html">
                <img src="{{ asset('assets/img/logo/logo.png') }}" class="img-fluid logo-blue 3" alt="Logo">
            </a>
            <a href="index-2.html">
                <img src="{{ asset('assets/img/logo/logo.png') }}" class="img-fluid logo-small 4" alt="Logo">
            </a>
        </div>
    </div>
    <!-- Sidebar Toggle -->
                ...
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fe fe-users"></i><span>Customers</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="{{ route('customers.index') }}"><i class="fe fe-users"></i>
